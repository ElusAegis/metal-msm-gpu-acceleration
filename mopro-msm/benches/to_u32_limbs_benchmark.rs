...
fn benchmark_to_u32_limbs(c: &mut Criterion) {
    ...
    #[cfg(feature = "ark")]
    {
        ...
        let ark_g_affine_instances: Vec<ArkGAffine> =
            ark_g_instances.iter().map(|g| g.into_affine()).collect();
        ...
        // Benchmark ArkFr
        {
            ...
            group.bench_function(BenchmarkId::new("ArkFr", SIZE), |b| {
                b.iter(|| {
                    ark_fr_instances
                        .as_slice()
                        .write_u32_limbs(ark_fr_limbs.as_mut_slice());
                });
            });
        }
        ...
        // Benchmark ArkG
        {
            ...
            group.bench_function(BenchmarkId::new("ArkG", SIZE), |b| {
                b.iter(|| {
                    ark_g_instances
                        .as_slice()
                        .write_u32_limbs(ark_g_limbs.as_mut_slice());
                });
            });
        }
        ...
        // Benchmark ArkGAffine
        {
            ...
            group.bench_function(BenchmarkId::new("ArkGAffine", SIZE), |b| {
                b.iter(|| {
                    ark_g_affine_instances
                        .as_slice()
                        .write_u32_limbs(ark_g_affine_limbs.as_mut_slice());
                });
            });
        }
    }
    ...
    #[cfg(feature = "h2c")]
    {
        ...
        let h2_g_affine_instances: Vec<H2GAffine> =
            h2_g_instances.iter().map(|g| g.to_affine()).collect();
        ...
        // Benchmark H2Fr
        {
            ...
            group.bench_function(BenchmarkId::new("H2Fr", SIZE), |b| {
                b.iter(|| {
                    h2_fr_instances
                        .as_slice()
                        .write_u32_limbs(h2_fr_limbs.as_mut_slice());
                });
            });
        }
        ...
        // Benchmark H2G
        {
            ...
            group.bench_function(BenchmarkId::new("H2G", SIZE), |b| {
                b.iter(|| {
                    h2_g_instances
                        .as_slice()
                        .write_u32_limbs(h2_g_limbs.as_mut_slice());
                });
            });
        }
        ...
        // Benchmark H2GAffine
        {
            ...
            group.bench_function(BenchmarkId::new("H2GAffine", SIZE), |b| {
                b.iter(|| {
                    h2_g_affine_instances
                        .as_slice()
                        .write_u32_limbs(h2_g_affine_limbs.as_mut_slice());
                });
            });
        }
    }
